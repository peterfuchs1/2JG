 ...
 * @version 1.0
 */
public class ItalienischLayout extends JPanel {
	...
	private Italienisch myModel; 	/* das Model */
	/**
	 * Konstruktor der View-Komponente
	 * @param c	Controller
	 * @param myModel Model
	 */
	public ItalienischLayout(ItalienischController c, Italienisch myModel) {
		...
		JLabel hinweis=new JLabel("Der Italienische Begriff lautet: ");
		oben.add(hinweis);
