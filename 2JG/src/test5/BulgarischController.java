...
public class BulgarischController implements ActionListener {
	private BulgarischLayout myPanel;				/* My JPanel              */
	private Bulgarisch myModel; 					/* My Model for this game */
	 ...
	 */
	public BulgarischController() {
		myModel = new Bulgarisch();
		myPanel = new BulgarischLayout(this, myModel);
